...
#define COLOR_RED           RGB(0xF3, 0x8B, 0xA8)
#define COLOR_GREEN         RGB(0xA6, 0xE3, 0xA1)
#define COLOR_BLUE          RGB(0x89, 0xB4, 0xFA)
#define COLOR_YELLOW        RGB(0xF9, 0xE2, 0xAF)
#define COLOR_CYAN          RGB(0x94, 0xE2, 0xD5)
#define COLOR_ORANGE        RGB(0xFA, 0xB3, 0x87)

#define COLOR_BRIGHTRED     RGB(0xF3, 0x8B, 0xA8)
#define COLOR_DARKRED       RGB(0xEB, 0x8B, 0xA8)
#define COLOR_BRIGHTYELLOW  RGB(0xF9, 0xE2, 0xAF)
#define COLOR_BRIGHTGREEN   RGB(0xA6, 0xE3, 0xA1)
#define COLOR_BRIGHTBLUE    RGB(0x74, 0xC7, 0xEC)
// #bedcd4 we are here
...
#ifndef COLOR_STD_BG
#define COLOR_STD_BG        RGB(0x1E, 0x1E, 0x2E)
#endif
#ifndef COLOR_STD_FONT
#define COLOR_STD_FONT      RGB(0xCD, 0xD6, 0xF4)
#endif
